...
<div align="center">
  <h1>Engineering 11 CRUD Core</h1>
</div>
<div align="center">
...
This is Engineering 11's fork of the excellent `@nestjsx/crud` core package, optimized for our ecosystem. This is the main package that provides the `@Crud()` decorator and core functionality.
...
```shell
npm i @engineering11/crud class-transformer class-validator
```

## Related Packages

- [**@engineering11/crud**](https://www.npmjs.com/package/@engineering11/crud) - this package - core package which provides `@Crud()` decorator for endpoints generation, global configuration, validation, helper decorators
