...
<div align="center">
  <h1>Engineering 11 CRUD TypeORM</h1>
</div>
<div align="center">
  <strong>for RESTful APIs built with NestJs</strong>
</div>
<div align="center">
  <em>Fork of <a href="https://github.com/nestjsx/crud">@nestjsx/crud-typeorm</a> optimized for the Engineering 11 ecosystem</em>
</div>
...
This is Engineering 11's fork of the excellent `@nestjsx/crud-typeorm` package, optimized for our ecosystem. This package provides TypeORM integration for the Engineering 11 CRUD microframework.
...
```shell
npm i @engineering11/crud-typeorm @nestjs/typeorm typeorm
```
...
- [**@engineering11/crud-typeorm**](https://www.npmjs.com/package/@engineering11/crud-typeorm) - this package - provides base `TypeOrmCrudService` with methods for CRUD database operations
